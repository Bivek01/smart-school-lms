...
export default function AdminSidebar({ isMobileOpen, setIsMobileOpen }) {
  ...
  const navItems = [
    ...
    { id: 'classes', label: 'Classes & Assignments', path: '/admin/dashboard/classes', icon: Layers },
    { id: 'users', label: 'User Management', path: '/admin/dashboard/users', icon: Users },
    { id: 'subjects', label: 'Subject Catalog', path: '/admin/dashboard/subjects', icon: BookOpen },
  ];
      ...
      >
        <div>
          ...
          <div className="mx-4 my-6 p-3.5 rounded-2xl bg-slate-800/80 border border-slate-700/60 flex items-center space-x-3">
            <div className="w-10 h-10 rounded-xl bg-purple-500/20 border border-purple-500/30 text-purple-400 flex items-center justify-center font-bold text-base shrink-0">
